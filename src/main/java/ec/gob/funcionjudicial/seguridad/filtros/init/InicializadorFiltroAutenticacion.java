 ...
 *
 */
public class InicializadorFiltroAutenticacion extends InicializadorFiltro {

	public InicializadorFiltroAutenticacion(FilterConfig filterConfig) {
		super(filterConfig);
	}
	...
	private void setParametrosCAS(Map<String, String> parametros){
		...
		parametros.put("casServerLoginUrl", Utils.getInstance().getPropiedad("cas.autenticacion.casServerLoginUrl"));
		parametros.put("renew", Utils.getInstance().getPropiedad("cas.autenticacion.renew"));
	}
